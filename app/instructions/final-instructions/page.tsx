      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-red-600">Final Instructions</h2>
          </div>
            ...
            <div className="max-w-3xl">
              ...
              <div className="flex justify-center gap-2 mt-8">
                {instructions.map((_, index) => (
                  <div
                    key={index}
                    className={`h-3 w-3 rounded-full cursor-pointer ${index === currentSlide ? "bg-red-600" : "bg-gray-300"}`}
          ...
          <div className="flex justify-between items-center mt-8">
            ...
            {currentSlide < instructions.length - 1 ? (
              ...
              <Button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 text-lg" onClick={handleStartGame}>
                Start Game
              </Button>
            )}
          </div>
