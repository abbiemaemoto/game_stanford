...
export default function FinalInstructionsPage() {
  ...
  const handleContinue = () => {
    router.push("/instructions/traits")
  }
        ...
        >
          ...
          <div className="flex-1 flex items-center justify-center">
            <p className="text-3xl text-gray-1000 text-center leading-relaxed max-w-3xl">
              At each turn, you'll move forward along the college path. You'll explore campus, face challenges, survive
              (or flake) through activities, and shape the kind of person you become by graduation.
            </p>
          </div>
