    ...
    <div className="min-h-screen bg-sky-200 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-[40%] transform -translate-x-1/2">
        <div className="relative">
          ...
          {/* Speech Bubble formatted like p3 */}
          <div className="absolute top-0 left-full ml-4 bg-white text-black text-2xl font-bold px-10 py-8 rounded-xl shadow-md w-[380px]">
            As you saw from the final activity, everyone's Stanford journey
            takes them somewhere unexpected & exciting. Cherish this fact, and
            remember that it's your journey that makes you a winner. Thanks for
            playing the Game of Stanford!
          </div>
        </div>
      </div>
