...
export default function StoryPage() {
  ...
  const handleContinue = () => {
    router.push("/game/commencement/p4");
  };
    ...
    <div className="min-h-screen bg-sky-200 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-[40%] transform -translate-x-1/2">
        <div className="relative">
            ...
            The Stanford experience is not defined by the amount of aura, health, or prodigy you may have...it's defined by the people surrounding you. 
            </div>
