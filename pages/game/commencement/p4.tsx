...
export default function StoryPage() {
  ...
  const handleContinue = () => {
    router.push("/game/commencement/p5");
  };
    ...
    <div className="min-h-screen bg-sky-200 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-[40%] transform -translate-x-1/2">
        <div className="relative">
            ...
            Everyone here will embark on a unique journey after Stanford. The secret to "winning" Stanford is to hold onto the people around you, no matter how different everyone's path may be.
            </div>
