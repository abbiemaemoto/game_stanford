  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-start justify-center overflow-hidden p-4">
      ...
      <div className="relative w-[70vw]">
        ...
        <Link href="activities/24-fortune-teller/fortune-teller1" className="absolute left-[6%] top-[17%] text-3xl">🔮</Link>
        <Link href="activities/13-formal/formal1" className="absolute left-[47%] top-[28%] text-3xl">🕺</Link>
        <Link href="activities/15-tahoe/tahoe1" className="absolute left-[56%] top-[19%] text-3xl">⛷️</Link>
        <Link href="activities/3-mascot/mascot1" className="absolute left-[72%] top-[10%] text-3xl">🎄</Link>
        <Link href="activities/7-axe/axe1" className="absolute left-[87%] top-[20%] text-3xl">🪓</Link>
        <Link href="activities/18-frost-fest/frost-fest1" className="absolute left-[67.5%] top-[32%] text-3xl">🎶</Link>
        <Link href="activities/16-winter-finals/winter-finals1" className="absolute left-[30%] top-[42%] text-3xl">🔍</Link>
        <Link href="activities/10-gym/gym1" className="absolute left-[32%] top-[50%] text-3xl">🏋️</Link>
        <Link href="activities/4-neighborhoods/neighborhoods1" className="absolute left-[45%] top-[48%] text-3xl">🌳</Link>
        <Link href="activities/14-moon/moon1" className="absolute left-[57%] top-[40%] text-3xl">🌕</Link>
        <Link href="activities/22-dinner-on-the-quad/dinner-on-the-quad1" className="absolute left-[48%] top-[41%] text-3xl">🍽️</Link>
        <Link href="activities/21-bay-to-breakers/bay-to-breakers1" className="absolute left-[60%] top-[32%] text-3xl">🏃🏻‍♀️</Link>
        <Link href="activities/23-end-of-year/end-of-year1" className="absolute left-[44%] top-[63%] text-3xl">🌟</Link>
