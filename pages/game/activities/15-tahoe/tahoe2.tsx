    ...
    <div className="relative min-h-screen w-full bg-sky-200 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-screen px-6">
        ...
        <h2 className="text-xl md:text-2xl lg:text-3xl font-medium text-white mt-6 max-w-3xl drop-shadow">
          In your last winter quarter, it’s time to finally head out to Tahoe
          and learn how to ski! You and your friends are super excited for a
          snowy weekend. Getting there can be a pain though..
        </h2>
      </div>
