        ...
        >
          ...
          <div className="flex-1 flex items-center justify-center">
            <p className="text-3xl text-gray-1000 text-center leading-relaxed max-w-3xl">
              Along the way, you'll collect Aura, Health, and Prodigy points -
              three traits that shape your choices, unlock surprises, and define
              your Stanford experience... maybe even who you are.
            </p>
          </div>
